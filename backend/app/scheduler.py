...
def start_scheduler():
    ...
    # from app.services.mediainfo_processor import check_mediainfo  # handled by mediainfo-agent on qBT servers
    ...
    scheduler.add_job(record_traffic, "interval", minutes=1, id="traffic_record")
